...
namespace MVCOBL.Controllers
{
	public class ProductosController : Controller
	{
		...
		{
			var mVCOBLContext = _context.Productos.Include(p => p.IdCategoriaNavigation);
		...
		[Authorize(Roles = "Admin")]
		public async Task<IActionResult> Create([Bind("IdProducto,Codigo,Nombre,Descripcion,Precio,Stock,IdCategoria,ImagenUrl,FechaRegistro")] Producto producto)
		{
			if (ModelState.IsValid)
			{
		...
		[ValidateAntiForgeryToken]
		[Authorize(Roles = "Admin")]
		public async Task<IActionResult> Edit(int id, [Bind("IdProducto,Codigo,Nombre,Descripcion,Precio,Stock,IdCategoria,ImagenUrl,FechaRegistro")] Producto producto)
		{
